...
<div class="wrap">
	...
	<h3 style="margin-top: 40px;">Create a custom page template with dedicated sidebar for widgets.</h3>
	...
	<?php else: ?>
		...
		<div style="margin-top: 60px;">
			<p>
				1) To use your new page template, please create a new <a href="edit.php?post_type=page">Page</a> and select your template name from the Page Template drop-down menu.
			</p>
			<p>
				2) To add sidebar widgets to the new page, please go to <a href="widgets.php">Widgets</a> and move widgets into the new custom widget area.
			</p>
		</div>
	<?php endif; ?>
