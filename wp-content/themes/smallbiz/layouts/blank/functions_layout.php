<?php
/**
 * Functions for Blank No Sidebar
 *
 * @package WordPress
...
function smallbiz_defaults_for_layout(){
  ...
  $smallbiz_defaults_for_layout = array(
	"noside_text" =>  '<h2>Welcome To My Business!</h2>
<p class="p">If you are looking for first-class service, you have come to the right place! We aim to be friendly and approachable. We are in your area and have what you need. We are here to serve you and answer any questions you may have.</p>
...
<div id="mainpagetext">
            ...
            <?php echo tinyMCE_HTMLarea('noside_text',get_option("smallbiz_noside_text")); ?>
